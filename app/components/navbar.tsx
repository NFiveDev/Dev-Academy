...
function MobileNavigation() {
  ...
  return (
    <>
      ...
      <div className='transition-all ease-in-out duration-1000 overflow-x-hidden'>
        <div
          className={`fixed z-40 lg:hidden bg-slate-800 w-[250px] top-0 right-0 bottom-0 ${drawerMargin}`}
        >
          <div className='py-2'>
        ...
        <ul className='flex gap-x-2'>
          <li>
            <Link href={'/course'}>
              <span
                className={
                  isLinkActive('/course') ? tailCurrentLinkClass : tailLinkClass
                }
              >
                Courses
              </span>
          ...
          <li>
            <Link href={'/about'}>
              <span
                className={
                  isLinkActive('/about') ? tailCurrentLinkClass : tailLinkClass
                }
              >
                About
              </span>
