...
export function ThemeToggle() {
  const { isLightMode, isDarkMode, enableDarkMode, disableDarkMode } =
    useTheme();
  ...
  return (
    <button
      ...
      className='mx-2 lg:mx-0 transition-all ease-in-out duration-300 dark:bg-gray-700 bg-gray-200 hover:bg-gray-400 cursor-pointer rounded-full h-fit p-1'
    >
